#!/usr/bin/env python3
"""
UTF-8-safe launcher for train_clap_v4.py  (4th fine-tune).
...
All extra arguments are forwarded directly to train_clap_v4.py.
"""
...
def main() -> None:
    ...
    log_path  = Path(
        os.environ.get("TRAINING_LOG",
                       repo_root / "training_run_fourth_fine_tune.log")
    )

    train_args = sys.argv[1:]
    cmd = [sys.executable, "-u",
           str(repo_root / "scripts" / "train_clap_v4.py")] + train_args
    ...
    with open(log_path, "a", encoding="utf-8") as log_fh:
        ...
        for line in io.TextIOWrapper(proc.stdout.buffer,
